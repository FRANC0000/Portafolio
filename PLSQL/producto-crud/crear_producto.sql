CREATE OR REPLACE FUNCTION crear_producto(comentario varchar, fecha_ingreso_producto timestamp,
...
$BODY$
DECLARE
	v_id_producto integer = nextval('seq_id_producto'); 
...
BEGIN
  ...
  insert into producto (id_producto, comentario, fecha_ingreso_producto, fecha_vencimiento,
					medida_producto, nombre_producto, stock_producto, valor_unitario, tipo_producto, eliminado)
					values (v_id_producto, v_comentario, v_fecha_ingreso_producto, v_fecha_vencimiento,
					v_medida_producto, v_nombre_producto, v_stock_producto, v_valor_unitario, v_tipo_producto, false);
