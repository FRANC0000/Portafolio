...
public interface ProductoRepository extends JpaRepository<Producto, Integer>{
	...
	@Query(value = "select modificar_producto(:id_producto, :comentario, :fecha_ingreso_producto, :fecha_vencimiento, :medida_producto, :nombre_producto, :stock_producto, :valor_unitario, :tipo_producto)", nativeQuery = true)
