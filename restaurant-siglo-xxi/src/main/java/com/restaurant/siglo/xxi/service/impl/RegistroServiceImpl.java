...
public class RegistroServiceImpl implements RegistroService{
	...
	public String obtenerSolicitudReabastecimientoRechazada() throws JSONException {
		...
		String resp = "";
		List<Registro> registros = registroRepository.obtenerSolicitudReabastecimientoRechazada();
		JSONObject objeto = new JSONObject();
		JSONArray list = new JSONArray();
	...
	public String obtenerSolicitudReabastecimientoModificada() throws JSONException {
		...
		String resp = "";
		List<Registro> registros = registroRepository.obtenerSolicitudReabastecimientoModificada();
		JSONObject objeto = new JSONObject();
		JSONArray list = new JSONArray();
	...
	public String obtenerSolicitudReabastecimientoProveedores() throws JSONException {
		...
		String resp = "";
		List<Registro> registros = registroRepository.obtenerSolicitudReabastecimientoProveedores();
		JSONObject objeto = new JSONObject();
		JSONArray list = new JSONArray();
	...
	public String obtenerSolicitudIngredientes() throws JSONException {
		...
		String resp = "";
		List<Registro> registros = registroRepository.obtenerSolicitudIngredientes();
		JSONObject objeto = new JSONObject();
		JSONArray list = new JSONArray();
	...
	public String actualizarUltimaVersionRegistro(Map<String, Object> registro) {
		...
		int id_registro = Integer.parseInt(registro.get("id_registro").toString());
		
		String resp = registroRepository.actualizarUltimaVersionRegistro(id_registro);
