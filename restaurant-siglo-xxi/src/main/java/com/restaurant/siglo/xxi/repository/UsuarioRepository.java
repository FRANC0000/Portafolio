...
public interface UsuarioRepository extends JpaRepository<Usuario, String>{
	...
	@Query(value = "select crear_usuario(:id_usuario, :nombre, :apP, :apM, :rut, :dv, :rol, :correo, :contrasena, :eliminado) ", nativeQuery = true)
	...
	@Query(value = "select modificar_usuario(:id_usuario, :nombre, :apP, :apM, :rut, :dv, :id_rol, :correo, :contrasena, :eliminado) ", nativeQuery = true)
